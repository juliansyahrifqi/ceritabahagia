...
export default function Portofolio() {
  return (
    <section className="py-5 mt-5 md:container mx-auto">
      <div className='grid md:grid-cols-2 gap-12 items-center px-10 md:px-24'>
        ...
        <div className='portfolio-information'>
          ...
          <h1 className='font-lato font-black text-5xl mt-8 leading-snug tracking-wide text-black'>Lihat apa yang sudah kami kerjakan</h1>

          <p className='text-sm font-medium text-secondary-black mt-8'>Kami selalu berusaha memberikan hasil yang terbaik untuk memuaskan para pelanggan kami.</p>
